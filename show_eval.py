...
def main():
    ...
    for ind, name in enumerate(im_names):
        ...
        # resize larger for better see
        large_img = cv2.resize(image, (strw, strh))
        cv2.imwrite(img_path, large_img)
